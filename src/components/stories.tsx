...
const Stories: React.FC = () => {
  ...
  if (senators.isFetching || representatives.isFetching) {
    return (
      <div className="flex-col">
        <div className="sticky z-10 mt-8 flex max-w-xl space-x-2">
        ...
        <div
          ref={ref}
          className="mt-8 flex h-full items-center space-x-2 overflow-x-scroll rounded-sm border border-gray-200 bg-white p-4 align-middle scrollbar-thin scrollbar-thumb-black"
        >
